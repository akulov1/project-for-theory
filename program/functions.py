...
# Cочетание
def combination(n, k):
   return f'{n}!/({n-k}!*{k}!)', math.factorial(n)/(math.factorial(k)*math.factorial(n-k)),f'C(из {n} по {k})'
...
local_teor_file = open("D:\Study\probability\program\local_teor.txt", "r")
local_teor_list = []
...
integr_teor_file = open('D:\Study\probability\program\integr_teor.txt', 'r')
integr_teor_dict = {}
counter = 0
